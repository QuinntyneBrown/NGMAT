...
using System.Text;
using ForceModel.Api.Endpoints;
using ForceModel.Infrastructure;
...
builder.Services.AddSwaggerGen(options =>
{
    ...
    {
        Title = "NGMAT Force Model API",
        Version = "v1",
        Description = "API for gravitational, atmospheric drag, and solar radiation pressure force models"
    });
...
// Add Force Model services
var connectionString = builder.Configuration.GetConnectionString("DefaultConnection")
    ?? "Server=localhost;Database=NGMAT_ForceModel;Trusted_Connection=True;TrustServerCertificate=True";
builder.Services.AddForceModel(connectionString);
...
if (app.Environment.IsDevelopment())
{
    ...
    app.UseSwaggerUI(c =>
    {
        c.SwaggerEndpoint("/swagger/v1/swagger.json", "NGMAT Force Model API v1");
    });
}
