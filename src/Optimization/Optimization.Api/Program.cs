...
using System.Text;
using Optimization.Api.Endpoints;
...
builder.Services.AddSwaggerGen(options =>
{
    ...
    {
        Title = "NGMAT Optimization API",
        Version = "v1",
        Description = "API for numerical optimization, trajectory optimization, and design space exploration"
    });
...
builder.Services.AddOptimizationInfrastructure();
...
if (app.Environment.IsDevelopment())
{
    ...
    app.UseSwaggerUI(c =>
    {
        c.SwaggerEndpoint("/swagger/v1/swagger.json", "NGMAT Optimization API v1");
    });
}
