...
builder.Services.AddSwaggerGen(options =>
{
    ...
    {
        Title = "NGMAT Reporting API",
        Version = "v1",
        Description = "API for report generation, data export, TLE generation, and mission summaries"
    });
...
if (app.Environment.IsDevelopment())
{
    ...
    app.UseSwaggerUI(c =>
    {
        c.SwaggerEndpoint("/swagger/v1/swagger.json", "NGMAT Reporting API v1");
    });
}
