...
using MissionManagement.Api.Endpoints;
...
builder.Services.AddSwaggerGen(c =>
{
    c.SwaggerDoc("v1", new Microsoft.OpenApi.Models.OpenApiInfo
    {
        ...
        Version = "v1",
        Description = "Mission lifecycle and configuration management"
    });
...
// Add Mission Management services
var connectionString = builder.Configuration.GetConnectionString("DefaultConnection")
    ?? "Server=(localdb)\\mssqllocaldb;Database=NGMAT_MissionManagement;Trusted_Connection=True;";
builder.Services.AddMissionManagement(connectionString);

// Add messaging (null publisher for now, will be replaced with Redis)
...
if (app.Environment.IsDevelopment())
{
    ...
    app.UseSwaggerUI(c =>
    {
        c.SwaggerEndpoint("/swagger/v1/swagger.json", "Mission Management API v1");
    });
}
