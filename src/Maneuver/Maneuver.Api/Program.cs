...
using System.Text;
using Maneuver.Api.Endpoints;
using Maneuver.Infrastructure;
...
builder.Services.AddSwaggerGen(options =>
{
    ...
    {
        Title = "NGMAT Maneuver API",
        Version = "v1",
        Description = "API for orbital maneuver planning, transfer orbit calculations, and fuel management"
    });
...
// Add Maneuver services
var connectionString = builder.Configuration.GetConnectionString("DefaultConnection")
    ?? "Server=localhost;Database=NGMAT_Maneuver;Trusted_Connection=True;TrustServerCertificate=True";
builder.Services.AddManeuver(connectionString);
...
if (app.Environment.IsDevelopment())
{
    ...
    app.UseSwaggerUI(c =>
    {
        c.SwaggerEndpoint("/swagger/v1/swagger.json", "NGMAT Maneuver API v1");
    });
}
