...
using System.Text;
using Propagation.Api.Endpoints;
using Propagation.Infrastructure;
...
builder.Services.AddSwaggerGen(options =>
{
    ...
    {
        Title = "NGMAT Propagation API",
        Version = "v1",
        Description = "API for orbit propagation with configurable integrators and force models"
    });
...
// Add Propagation services
var connectionString = builder.Configuration.GetConnectionString("DefaultConnection")
    ?? "Server=localhost;Database=NGMAT_Propagation;Trusted_Connection=True;TrustServerCertificate=True";
builder.Services.AddPropagation(connectionString);
...
if (app.Environment.IsDevelopment())
{
    ...
    app.UseSwaggerUI(c =>
    {
        c.SwaggerEndpoint("/swagger/v1/swagger.json", "NGMAT Propagation API v1");
    });
}
